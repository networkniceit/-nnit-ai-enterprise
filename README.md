...
### Full Featured One-Line Command

```powershell
Get-ChildItem -Path . -Recurse -File | `
  Where-Object { $_.FullName -notmatch '[\\/]\.git[\\/]' } | `
  ForEach-Object { Write-Host "=== $($_.Name) ===" -ForegroundColor Cyan; Get-Content $_.FullName; Write-Host "" }
```
...
$files = @("README.md", "LICENSE"); `
  $files | ForEach-Object { if (-not (Test-Path $_)) { "Creating $_"; New-Item $_ -ItemType File -Value "# $_`n" } }; `
  Get-ChildItem -Recurse -File | Where-Object { $_.FullName -notmatch '\.git' } | ForEach-Object { "=== $($_.Name) ==="; Get-Content $_; "" }
```
